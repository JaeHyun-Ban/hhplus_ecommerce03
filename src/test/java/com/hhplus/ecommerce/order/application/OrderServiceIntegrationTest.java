...
class OrderServiceIntegrationTest {
    ...
    @Autowired
    private com.hhplus.ecommerce.cart.infrastructure.persistence.CartItemRepository cartItemRepository;
    ...
    class CreateOrderIntegrationTest {
        ...
        void createOrder_Fail_InsufficientBalance() {
            ...
            // When
            Order result = orderService.createOrder(poorUser.getId(), null, idempotencyKey);
