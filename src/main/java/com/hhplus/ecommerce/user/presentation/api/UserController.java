package com.hhplus.ecommerce.user.presentation.api;

import com.hhplus.ecommerce.user.application.BalanceService;
import com.hhplus.ecommerce.user.application.UserService;
import com.hhplus.ecommerce.user.domain.BalanceHistory;
import com.hhplus.ecommerce.user.domain.User;
import com.hhplus.ecommerce.user.presentation.api.dto.BalanceResponse;
import com.hhplus.ecommerce.user.presentation.api.dto.ChargeBalanceRequest;
import com.hhplus.ecommerce.user.presentation.api.dto.RegisterUserRequest;
import com.hhplus.ecommerce.user.presentation.api.dto.UserResponse;
